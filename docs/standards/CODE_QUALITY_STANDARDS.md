...
**EM DASH is never allowed anywhere in the fleet, any filetype** (broadened 2026-07-13 from the original script-only scope). See [patterns/unicode_safety.md](./patterns/unicode_safety.md).
