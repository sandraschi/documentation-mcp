...
| Topic | Bar |
|-------|-----|
| **FastMCP** | **3.4.4+** — `fastmcp>=3.4.4,<4`, `prefab-ui>=0.14.0` core dep. Current SOTA: **3.4.4** (3.4.3 had Host/Origin guard regression — skip it, 3.4.4 is the fix). **New repos MUST target 3.4.4+.** Existing repos on 3.2.x may stay until active work touches their deps. |
...
**Version:** 2026-07-13 (FastMCP SOTA line refreshed to 3.4.4, verified against PyPI; rest of snapshot unchanged from 2026-06-17) · Owner: Sandra Schipal
