...
git clone https://github.com/sandraschi/obscura-mcp
cd obscura-mcp
just
```
...
4. Start the server:
   ...
   uv run python -m obscura_mcp.server

   # HTTP mode (for web dashboard)
   uv run uvicorn obscura_mcp.server:app --port 
   ```
...
| Something else | [Open a GitHub issue](https://github.com/sandraschi/obscura-mcp/issues) |
