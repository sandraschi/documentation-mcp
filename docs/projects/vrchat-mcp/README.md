...
A FastMCP 3.1.1++ implementation for controlling VRChat avatars and assets via OSC protocol. **Designed primarily for Claude Desktop integration** - allows you to control VRChat using natural language commands. Also provides FastAPI HTTP API for web access.
...
[![FastMCP](https://img.shields.io/badge/FastMCP-3.1.1++-green)](https://github.com/jlowin/fastmcp)
...
- **âœ… FastMCP 3.1.1++ Compatible** - Dual interface support (MCP stdio + FastAPI HTTP)
- **âœ… Plugin System** - Extensible architecture with decorator-based tool registration
- **âœ… OSC Integration** - Bidirectional communication with VRChat using Open Sound Control
- **âœ… Avatar Control** - Basic parameter management for VRChat avatars
- **âœ… Parameter Indexing** - Fast lookup of avatar parameters and OSC endpoints
- **âœ… Help System** - Built-in documentation for all registered tools
- **âœ… Modular Architecture** - Clean tool organization in category subdirectories
- **âœ… Production Testing** - Comprehensive unit, integration, and API testing

## Planned Features

- **ðŸ”„ Intelligent NPCs** - Advanced conversation management with language model integration
- **ðŸ”„ Advanced Avatar Control** - Smooth interpolation and complex avatar state management
- **ðŸ”„ FastSearch** - Sophisticated search and indexing across all VRChat assets
- **ðŸ”„ Performance Monitoring** - Advanced metrics and rate limiting

## Production Readiness Status

| Component | Status | Notes |
|-----------|--------|-------|
| **Dual Interface** | âœ… Complete | MCP stdio + FastAPI HTTP with `/health`, `/api/docs`, and `/api/v1/openapi.json` |
| **Modular Architecture** | âœ… Complete | Tools organized in category subdirectories |
| **Tool Registration** | âœ… Complete | Proper `@mcp.tool()` multiline decorators |
| **Testing Infrastructure** | âœ… Complete | Unit tests, integration tests, Postman collection |
| **Documentation** | âœ… Complete | README, CHANGELOG, CONTRIBUTING, SECURITY |
| **CLI Interface** | âœ… Complete | Command-line interface with dual/fastapi/mcp modes |
| **Error Handling** | âœ… Complete | Comprehensive error handling with graceful degradation |
| **Logging** | âœ… Complete | Structured logging with configurable levels |
| **FastAPI Endpoints** | âœ… Complete | Health check, OpenAPI docs, and API schema endpoints |
| **Basic OSC Integration** | âœ… Complete | OSC message sending and parameter indexing |
| **Plugin System** | âœ… Complete | Extensible plugin architecture with decorators |
| **Server Startup** | âœ… Complete | Reliable server startup in all modes |
| **Avatar Control** | âœ… Complete | Basic parameter get/set operations |
| **Parameter Indexing** | âœ… Complete | Fast lookup of avatar parameters and OSC endpoints |
| **Advanced NPC System** | âŒ Planned | Language model integration and conversation management |
| **Advanced Avatar Control** | âŒ Planned | Smooth interpolation and complex state management |
| **Performance Monitoring** | âŒ Planned | Advanced metrics and comprehensive rate limiting |
| **GitHub Infrastructure** | âš ï¸ Partial | Repository structure ready, CI/CD pending |
