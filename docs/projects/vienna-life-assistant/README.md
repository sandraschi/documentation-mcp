...
- **🏠 Tapo MCP**: Smart home control ([sandraschi/devices-mcp](https://github.com/sandraschi/devices-mcp))
...
cd D:\Dev\repos
git clone https://github.com/sandraschi/devices-mcp.git
cd devices-mcp
...
**Configuration:**
- Path: `D:/Dev/repos/devices-mcp/src/tapo_mcp/server.py`
...
$env:TAPO_MCP_PATH="D:/Dev/repos/devices-mcp/src/tapo_mcp/server.py"
