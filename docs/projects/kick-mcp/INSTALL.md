...
4. Start the server:
   ...
   uv run python -m kick_mcp.server

   # HTTP mode (for web dashboard)
   uv run uvicorn kick_mcp.server:app --port 10968
   ```
5. Open `http://localhost:10968` or the frontend URL.
...
| Something else | [Open a GitHub issue](https://github.com/sandraschi/kick-mcp/issues) |
