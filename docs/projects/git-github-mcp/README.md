...
FastMCP 3.1.1+.4 portmanteau server for Git and GitHub operations. Uses `gh` CLI for GitHub; avoids the 40-tool explosion.
...
# 2. Webapp: npm first, then start (kills zombies on 11900)
cd web
npm install
.\start.ps1
```
