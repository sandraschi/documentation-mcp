...
**🚀 SOTA 2026 Federated Robotics Fleet Coordination Platform**

**The `robotics-mcp` project is now the central architectural hub for a federated fleet of specialized robots. This project provides the intelligent orchestration layer, shared spatial database, and unified dashboard for multi-robot missions. Dynamic robot control has been delegated to specialized servers like `yahboom-mcp` and `dreame-mcp`.**

*Architectural shift: From monolithic control to modular autonomy. Leveraging the SOTA 2026 Federated Design Pattern.*
...
### **Software (MANDATORY)**
- ✅ **Unity 3D** (6000.3.1.1+f1+) - [Installation Guide](docs/SETUP_PREREQUISITES.md#unity-3d-required-for-virtual-robotics)
...
[![FastMCP](https://img.shields.io/badge/FastMCP-3.1.1++-blue)](https://gofastmcp.com)
[![Web Interface](https://img.shields.io/badge/Web--Interface-Professional-purple)]()
[![Python](https://img.shields.io/badge/Python-3.10+-green)](https://www.python.org)
[![Unity](https://img.shields.io/badge/Unity-6000.3.1.1++-black)](https://unity.com)
...
- **FastMCP 3.1.1+.5 Integration**: Leverages the newest FastMCP library for seamless contextual routing.
...
# Then install Unity Editor version 6000.3.1.1+f1 or later:
# 1. Open Unity Hub
# 2. Go to "Installs" tab
# 3. Click "Add" → "Official releases"
# 4. Select "6000.3.1.1+f1" (LTS recommended)
...
**Alpha with real hardware integration. FastMCP 3.1.1++ compliant.**
...
- **MCP Transport** - Dual stdio + HTTP, FastMCP 3.1.1++ with `ctx: Context` on all tools
...
**Status**: Alpha v0.2.0 (2026-02-08) - FastMCP 3.1.1++ compliant, Dreame D20 Pro working, Yahboom roslibpy integrated, Gazebo Fuel browser operational, webapp fully navigable.
