...
4. Start the server:
   ...
   uv run python -m myai.server

   # HTTP mode (for web dashboard)
   uv run uvicorn myai.server:app --port 10889
   ```
5. Open `http://localhost:10889` or the frontend URL.
...
| Something else | [Open a GitHub issue](https://github.com/sandraschi/myai/issues) |
