...
**AI-powered video conferencing platform** with LiveKit WebRTC, voice agent, and remote desktop control. Built on Turborepo and FastMCP 3.4+.

**Version**: 0.1.0 | **Status**: Active Development | **Ports**: Web 10886, Conferencing MCP 10720, Remoting MCP 10725, Agent 10887
