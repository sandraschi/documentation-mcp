...
A FastMCP 3.1.1++ server implementation for managing Plex Media Server with a clean, type-safe API.
...
- **Neural Media RAG**: High-speed LanceDB semantic retrieval via the `plex_rag` unified tool and backend API.
