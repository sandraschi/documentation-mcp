# Windows Computer Use MCP - Project Status
...
Windows Computer Use MCP (formerly pywinauto-mcp) is a FastMCP 3.2+ compliant server providing **programmatic control of the Windows desktop** through the Model Context Protocol. It enables AI agents (Claude, DeepSeek, etc.) to see, interact with, and automate any Windows application.
...
```json
{
  "mcpServers": {
    "windows-computer-use": {
      ...
      "cwd": "D:\\Dev\\repos\\windows-computer-use-mcp"
    }
  }
}
```
...
- [Usage Scenarios](../../../windows-computer-use-mcp/docs/USAGE_SCENARIOS.md)
