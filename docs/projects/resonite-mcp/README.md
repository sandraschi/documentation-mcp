...
**FastMCP 3.1.1+.3+ compliant server for natural language control of Resonite social VR platform.**

[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![Python 3.12+](https://img.shields.io/badge/python-3.12+-blue.svg)](https://www.python.org/downloads/)
[![FastMCP 3.1.1+.3+](https://img.shields.io/badge/FastMCP-3.1.1+.3+-green.svg)](https://gofastmcp.com/)
...
- **Cloud Session Browser**: Browse public world sessions from `api.resonite.com` â€” thumbnails, user counts, join deep links
- **World Inspector** *(NEW)*: Live scene-graph browser â€” traverse slots, inspect components, edit fields via ResoniteLink
...
This server follows FastMCP 3.1.1++ SOTA standards with:
...
```
resonite-mcp/
â”œâ”€â”€ src/resonite_mcp/
â”‚   â”œâ”€â”€ __init__.py          # Package initialization
â”‚   â”œâ”€â”€ server.py            # Main MCP server with all tools
â”‚   â”œâ”€â”€ cli.py               # Command-line interface
â”‚   â””â”€â”€ http_server.py      # FastAPI HTTP server
â”œâ”€â”€ tests/
...
â”œâ”€â”€ assets/prompts/          # MCP prompt templates
...
### v0.2.0 (2026-02-23) â€” Webapp Expansion
- âœ… **Cloud Session Browser**: `GET /api/sessions` proxies `api.resonite.com` public sessions
- âœ… **World Inspector page**: live slot hierarchy tree, inspector panel, field display
- âœ… **Asset Injection panel**: inject VRM avatars, props, furniture, architecture via ResoniteLink `importFile`
- âœ… Canonical asset dirs established (`~/.avatarmcp/models/`, `~/Documents/ResoniteAssets/`)
- âœ… `httpx` dependency added for async cloud API proxy
- âœ… New backend routes: `/rl/world/root|children|node`, `/rl/world/asset-files`, `/rl/world/import-vrm`
- âœ… Sidebar and routing wired for new World page

### v0.1.0 (December 2025) â€” Initial Release
- Fixed MCP stdio mode startup issues
- Added HTTP API endpoints (25+ endpoints)
- Implemented 31 MCP tools with FastMCP 3.1.1+.1+ compliance
...
**Made with â¤ï¸ for the Resonite community**
