...
*A comprehensive FastMCP 3.1.1+.3-powered monitoring server providing intelligent operations across Grafana, Prometheus, and Loki ecosystems with conversational AI assistance for DevOps workflows.*
...
- FastMCP 3.1.1+.3+ (installed automatically)
...
### Code Standards
- **FastMCP 3.1.1+.3+**: Use latest features and patterns
...
**Built with ❤️ using FastMCP 3.1.1+.3 for intelligent monitoring operations**
