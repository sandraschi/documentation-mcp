...
|--------|---------|------------|------|
| **Tapo Camera MCP** | Cameras & Energy | `devices-mcp` | 7778-7780 |
...
|---------|---------|---------------|
| **WorldLabs.ai** | 3D World Generation | [WorldLabs API Docs](docs/integrations/worldlabs-api.md) |
...
|----------|----------|-------|
| **Camera** | devices-mcp, ring-mcp | 8 servers |
...
- **MCP Servers** (strongly recommended for full functionality):
  - `devices-mcp` (port 7778) - Cameras, energy monitoring, smart plugs
...
# External API Keys
WORLDLABS_API_KEY=marble1 QRSx0WlSPCx3tK92R1tF4jrF5lztHPB6
```
