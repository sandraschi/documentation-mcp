...
4. Start the server:
   ...
   uv run python -m rustdesk_mcp.server

   # HTTP mode (for web dashboard)
   uv run uvicorn rustdesk_mcp.server:app --port 10805
   ```
5. Open `http://localhost:10805` or the frontend URL.
...
| Something else | [Open a GitHub issue](https://github.com/sandraschi/rustdesk-mcp/issues) |
