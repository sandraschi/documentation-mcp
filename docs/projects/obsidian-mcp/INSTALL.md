...
4. Start the server:
   ...
   # HTTP gateway only
   uv run uvicorn obsidian_mcp.gateway:app --host 127.0.0.1 --port 10915
   ```
5. Open `http://127.0.0.1:10890` (dashboard) or `http://127.0.0.1:10915/health` (gateway).
...
| Something else | [Open a GitHub issue](https://github.com/sandraschi/obsidian-mcp/issues) |
