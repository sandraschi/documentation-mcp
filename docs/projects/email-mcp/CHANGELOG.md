...
### Added
- **FastMCP 3.1.1+.3 Standards Compliance**: Updated to latest FastMCP protocol version
...
### Technical
- Upgraded FastMCP dependency to >=3.1.1+.3,<3.0.0
...
### Added
- **Server-to-Server Communication**: Leverages FastMCP 3.1.1+.1 capabilities for direct MCP server collaboration
...
- FastMCP 3.1.1+.1 server communication framework for cross-server collaboration
