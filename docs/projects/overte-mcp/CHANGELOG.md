...
- Headless/client script [overte-mcp-bridge.js](scripts/overte-mcp-bridge.js) to run inside Overte Interface or Server console, enabling live, real-time in-world entity spawning and JS behavior injection.
