...
4. Start the server:
   ...
   uv run python -m documentation_mcp.server

   # HTTP mode (for web dashboard)
   uv run uvicorn documentation_mcp.server:app --port 10791
   ```
5. Open `http://localhost:10791` or the frontend URL.
...
| Something else | [Open a GitHub issue](https://github.com/sandraschi/documentation-mcp/issues) |
