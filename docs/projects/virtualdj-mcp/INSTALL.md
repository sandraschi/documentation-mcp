...
4. Start the server:
   ...
   uv run python -m virtualdj_mcp.server

   # HTTP mode (for web dashboard)
   uv run uvicorn virtualdj_mcp.server:app --port 10877
   ```
5. Open `http://localhost:10877` or the frontend URL.
...
| Something else | [Open a GitHub issue](https://github.com/sandraschi/virtualdj-mcp/issues) |
