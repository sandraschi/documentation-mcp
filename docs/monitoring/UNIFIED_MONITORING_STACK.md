...
> **June 2026:** Operational truth (host ports **12000–12006**, fleet scrape, host logs, dashboards) is in **[MONITORING_CURRENT_SETUP.md](./MONITORING_CURRENT_SETUP.md)**. This document retains architecture context; examples using `:3000` / `:9090` are legacy.
