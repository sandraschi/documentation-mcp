/**
 * useZoom — Ctrl+Scroll wheel zoom for Tauri + dev browser.
 *
 * Steps through ZOOM_LEVELS, persists to localStorage, works in Tauri
 * (via window.setZoom) and in dev browser (via CSS zoom).
 */
