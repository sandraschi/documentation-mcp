...
The fleet standard was updated to `fastmcp>=3.1.0` in March 2026. See `archive/fastmcp/3.1-features.md` and `archive/fastmcp/3.0-to-3.1-improvements.md` for full details.
