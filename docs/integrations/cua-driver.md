...
**Fleet counterpart:** [windows-computer-use-mcp](../projects/windows-computer-use-mcp/README.md)

## Fleet stance

- **Not** a fleet-maintained MCP repo today.
- **windows-computer-use-mcp** is the integration point for host desktop automation (HTTP **10789**, bridge alias **`pywinauto`** in fleet-agent-mcp).
