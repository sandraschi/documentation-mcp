...
All MCP webapp dashboards MUST use ports from the reserved range **10700-11500**. NEVER use 3000, 5000, 5173, 8000, or 8080. See [Webapp Port Reservoir](../operations/WEBAPP_PORTS.md) for the allocation registry and your assigned port.
