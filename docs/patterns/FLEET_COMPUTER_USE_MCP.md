...
| **Finger (Win32 UI)** | **[pywinauto-mcp](../projects/pywinauto-mcp/README.md)** | Click, type, focus windows, traverse controls, visual/OCR-style ops via portmanteau tools — **primary “clicker/scraper”** for apps without APIs |
...
## Why pywinauto-mcp is the default “finger”
...
Vendor **[Cua Driver](https://cua.ai/docs/cua-driver/guide/getting-started/introduction)** targets **no-foreground** host automation. Fleet **pywinauto-mcp** is adopting a **Cua-shaped** API (`get_window_state`, `snapshot_id`, `element_index`, `capture_mode`) while keeping **HITL / kill switch**. Full comparison, Excel/Cursor FAQ, and **fleet-agent-mcp** bridge notes: **[CUA_DRIVER_AND_PYWINAUTO.md](./CUA_DRIVER_AND_PYWINAUTO.md)**.

## Related docs

- **[CUA_DRIVER_AND_PYWINAUTO.md](./CUA_DRIVER_AND_PYWINAUTO.md)** — Cua Driver vs pywinauto-mcp; background loop; fleet-agent cross-connect
...
- [pywinauto-mcp README](../projects/pywinauto-mcp/README.md)
