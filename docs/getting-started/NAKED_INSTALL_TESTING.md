...
**Fleet batch probe (2026-06-07)**: [FLEET_COLD_INSTALL_PROBE.md](../docs/operations/FLEET_COLD_INSTALL_PROBE.md) — meta_mcp orchestrates, consumer sandbox executes, Broken\* reinstall-after-fix. Work tracker: [projects/fleet-cold-install/TODO.md](../projects/fleet-cold-install/TODO.md).  
