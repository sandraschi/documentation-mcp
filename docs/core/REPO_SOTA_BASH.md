# REPO_SOTA_BASH: Industrial Modernization Recipe (April 2026)

> [!IMPORTANT]
> **SOTA v13.1 Compliance**: This document is the authoritative guide for "bashing" a legacy or 2.x repository into 2026 April compliance. It prioritizes FastMCP 3.2, `uv`, and high-fidelity Markdown outputs.
...
2.  **FastMCP 3.2**: `uv add "fastmcp>=3.2.0"`.
...
1.  **`start.ps1`**: PowerShell launcher with port cleanup (10700-10800 range).
