...
## 1. Overview
The GitHub CLI (`gh`) is the mandatory low-level interface for all repository management and orchestration tasks that exceed the scope of standard Git operations.
