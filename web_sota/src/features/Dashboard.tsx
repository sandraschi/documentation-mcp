...
import { Activity, Book, Database, Server, Zap, Loader2 } from "lucide-react"
...
export function Dashboard() {
    ...
    return (
        <div className="flex-1 flex flex-col min-h-0 container max-w-6xl mx-auto py-8 px-4 space-y-12 overflow-y-auto">
                    ...
                    <div className="flex flex-col items-end gap-3 shrink-0">
                        <div className="flex items-center gap-3 bg-emerald-500/10 border border-emerald-500/20 px-4 py-2 rounded-xl transition-all duration-300 hover:bg-emerald-500/15">
                            ...
                            <span className="text-sm font-semibold text-emerald-500 uppercase tracking-widest">
                                {status?.status === "ready" ? "Operational" : status?.status === "index_empty" ? "Index Empty" : "Initializing"}
                            </span>
                        </div>
